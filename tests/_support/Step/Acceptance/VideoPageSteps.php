...
class VideoPageSteps
{
     ...
     * ! Важно! Это не означает, что каждая проверка займет 1 секунду: если картинка обновится быстрее чем за 1 секунду,
     * то условие сработает и цикл перейдет к следующей проверке
     *
     * @param $element
     * @param $changes_count
     * @param $image_change_timeout
